...
class TestErrorHandlers:
    ...
    def test_handle_prediction_generic_error(self):
        ...
        assert exc_info.value.status_code == 500
        assert exc_info.value.detail == "An unexpected internal server error occurred."
    ...
    def test_handle_metrics_error(self):
        ...
        assert exc_info.value.status_code == 500
        assert exc_info.value.detail == "Failed to retrieve application metrics."
    ...
    def test_handle_prometheus_metrics_error(self):
        ...
        assert exc_info.value.status_code == 500
        assert exc_info.value.detail == "Failed to retrieve Prometheus metrics."
