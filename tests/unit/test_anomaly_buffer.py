...
from app.services.anomaly_buffer import AnomalyEntry, BoundedAnomalyBuffer, get_anomaly_buffer
...
class TestGetAnomalyBuffer:
    ...
    def test_singleton_initialization(self, mock_get_settings):
        ...
        mock_settings.performance.anomaly_buffer_max_size = 5000
        mock_settings.performance.anomaly_buffer_default_ttl = 7200
    ...
    def test_singleton_uses_settings(self, mock_get_settings):
        ...
        mock_settings = MagicMock()
        mock_settings.performance.anomaly_buffer_max_size = 2500
        mock_settings.performance.anomaly_buffer_default_ttl = 1800
        mock_get_settings.return_value = mock_settings
