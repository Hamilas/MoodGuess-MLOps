...
from app.core.secrets import EnvSecretManager, VaultSecretManager, get_secret_manager
from app.monitoring.vault_health import VaultHealthMonitor, get_vault_monitor
...
class TestVaultSecretManager:
    ...
    def test_kubernetes_authentication(self, mock_open, mock_hvac_client):
        ...
        VaultSecretManager(vault_addr="http://vault:8200", role="mlops-sentiment")
...
class TestSecretManagerFactory:
    ...
    def test_get_vault_secret_manager(self, mock_vault_class):
        ...
        get_secret_manager(vault_enabled=True, vault_addr="http://vault:8200")
