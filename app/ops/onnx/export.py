    ...
    def export_model(
        ...
        Args:
            ...
            model_revision: Hugging Face Hub revision (branch, tag, or commit
                SHA) to pin when downloading the model/tokenizer. Override
                with an immutable commit SHA in production (CWE-494).
            ...
            if quantize:
                ...
                if legacy_quantized_path != quantized_path and not legacy_quantized_path.exists():
                    try:
                        ...
                        # scripts/ops/convert_to_onnx.py depends on this specific filename
                        logger.error(
