...
class ServiceError(Exception):
    ...
    def __init__(self, message: str, code: str = "E0000", context: Any | None = None):
...
class ModelNotLoadedError(ModelError):
    ...
    def __init__(self, model_name: str | None = None, context: Any | None = None):
...
class ModelInferenceError(ModelError):
    ...
    def __init__(self, message: str, model_name: str | None = None, context: Any | None = None):
...
class InvalidModelError(ValidationError):
    ...
    def __init__(self, model_name: str, allowed_models: list[str], context: Any | None = None):
...
class TextValidationError(ValidationError):
    ...
    def __init__(self, message: str, text_length: int | None = None, context: Any | None = None):
...
class TextTooLongError(TextValidationError):
    ...
    def __init__(self, text_length: int, max_length: int, context: Any | None = None):
...
class BatchSizeExceededError(ValidationError):
    ...
    def __init__(self, batch_size: int, max_batch_size: int, context: Any | None = None):
...
class VaultAuthenticationError(AuthenticationError):
    ...
    def __init__(
        self, message: str = "Failed to authenticate with Vault", context: Any | None = None
    ):
...
class KubernetesAuthenticationError(AuthenticationError):
    ...
    def __init__(
        self, message: str = "Kubernetes authentication failed", context: Any | None = None
    ):
...
class ModelInitializationError(InternalError):
    ...
    def __init__(self, message: str, backend: str | None = None, context: Any | None = None):
...
class ModelMetadataNotFoundError(NotFoundError):
    ...
    def __init__(self, model_identifier: str, context: Any | None = None):
...
class InvalidModelPathError(ValidationError):
    ...
    def __init__(self, path: str, context: Any | None = None):
...
class UnsupportedBackendError(ValidationError):
    ...
    def __init__(self, backend: str, supported_backends: list[str], context: Any | None = None):
...
class ServiceNotStartedError(InternalError):
    ...
    def __init__(self, service_name: str, context: Any | None = None):
...
class CircuitBreakerOpenError(ServiceUnavailableError):
    ...
    def __init__(
        self, service_name: str, retry_after: int | None = None, context: Any | None = None
    ):
...
class HealthCheckError(InternalError):
    ...
    def __init__(self, component: str, message: str, context: Any | None = None):
