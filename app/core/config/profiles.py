...
class DevelopmentProfile(ConfigProfile):
    ...
    def get_overrides(self) -> dict[str, Any]:
        ...
        return {
            ...
            "MLOPS_API_KEY": "",
            "MLOPS_ALLOWED_ORIGINS": '["http://localhost:3000", "http://localhost:5173"]',
            "MLOPS_CORS_ORIGINS": '["http://localhost:3000", "http://localhost:5173"]',
    ...
    def get_overrides(self) -> dict[str, Any]:
        ...
        return {
            ...
            "MLOPS_ALLOWED_ORIGINS": (
                '["https://staging.example.com", "https://staging-app.example.com"]'
            ),
...
class ProfileRegistry:
    ...
    _profiles: ClassVar[dict[str, ConfigProfile]] = {
        "local": LocalProfile(),
    ...
    @classmethod
    def get_profile(cls, profile_name: str) -> ConfigProfile | None:
    ...
    def get_available_profiles(cls) -> dict[str, str]:
        ...
        for _name, profile in cls._profiles.items():
