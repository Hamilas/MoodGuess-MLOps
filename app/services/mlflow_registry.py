"""
MLflow Model Registry integration for MoodGuess.
...
from app.interfaces.registry_interface import IModelRegistry, ModelStage
...
class ModelRegistry(IModelRegistry):
    ...
    def get_model_version(
        self, model_name: str, version: int | None = None, stage: ModelStage | None = None
    ) -> dict[str, Any] | None:
        """
...
def initialize_model_registry(
    tracking_uri: str | None = None, enabled: bool = True
) -> ModelRegistry:
