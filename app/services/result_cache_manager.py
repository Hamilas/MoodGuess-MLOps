...
class ResultCacheManager:
    ...
    def __init__(self, settings: Settings):
        ...
        self._max_cache_size = self.settings.performance.async_batch_result_cache_max_size
    ...
    async def get_cached_result(
        ...
        async with self._ensure_lock():
            ...
            results: list[dict[str, Any]] = cache_entry["results"]
            return results
    ...
    async def _enforce_cache_size_limit(self) -> None:
        ...
        logger.debug(f"Enforced cache size limit, removed {num_to_remove} oldest entries")
