"""
Model Drift Detection for MoodGuess.
...
try:
    ...
    from evidently.test_suite import TestSuite  # noqa: F401
    from evidently.tests import TestNumberOfDriftedColumns  # noqa: F401
...
class DriftDetector(IDriftDetector):
    ...
    def __init__(
        ...
        self.last_drift_check: datetime | None = None
    ...
    def check_drift(self) -> DriftMetrics | None:
        """
...
_drift_detector_instance: DriftDetector | None = None
