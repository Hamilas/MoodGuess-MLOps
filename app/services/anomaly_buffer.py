...
class BoundedAnomalyBuffer(IAnomalyBuffer):
    ...
    def get(self, entry_id: str) -> AnomalyEntry | None:
...
_anomaly_buffer: BoundedAnomalyBuffer | None = None
...
def get_anomaly_buffer() -> BoundedAnomalyBuffer:
    ...
    if _anomaly_buffer is None:
        ...
        _anomaly_buffer = BoundedAnomalyBuffer(
            max_size=settings.performance.anomaly_buffer_max_size,
            default_ttl=settings.performance.anomaly_buffer_default_ttl,
        )
