...
class PartitionRebalanceListener:
    ...
    def __init__(
        self,
        instance_id: str,
        on_partitions_assigned: Callable | None = None,
        on_partitions_revoked: Callable | None = None,
    ):
...
class DistributedKafkaConsumer:
    ...
    def poll(self, timeout_ms: int = 1000) -> dict[TopicPartition, list[Any]]:
        ...
        """
        raise NotImplementedError("DistributedKafkaConsumer.poll is not yet implemented")
