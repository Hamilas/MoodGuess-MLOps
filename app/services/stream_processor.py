...
try:  # pragma: no cover - optional dependency in tests
    ...
    from app.utils.logging_adapters import get_fallback_contextual_logger, get_fallback_logger

    get_contextual_logger = get_fallback_contextual_logger  # type: ignore[assignment]
    get_logger = get_fallback_logger  # type: ignore[assignment]
...
try:  # pragma: no cover
    ...
    class OnlineStandardScaler:  # type: ignore[no-redef]
        ...
        def load_state(self, *_: Any, **__: Any) -> None:  # - simple stub
...
class StreamProcessor(IStreamProcessor):
    ...
    def __init__(self, model: ModelStrategy, config: BatchConfig | None = None):
    ...
    def _process_features(self, texts: list[str], batch_logger) -> None:
        ...
        # Logging already handled in FeatureProcessor
