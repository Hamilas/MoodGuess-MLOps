...
from app.core.dependencies import get_model_service, require_initialized
...
async def get_async_batch_service(
    ...
    service: AsyncBatchService = request.app.state.async_batch_service
    return service
...
async def detailed_health_check(
    ...
    result = await monitoring_service.get_detailed_health(request, model, secret_manager)
...
async def health_check(
    ...
    result = await monitoring_service.get_simple_health(model, secret_manager)
...
@router.get("/monitoring/drift/report", summary="Export drift report")
...
async def list_models(
    filter_string: str | None = Query(default=None, description="Filter expression"),
...
@router.post("/monitoring/explain/html", summary="Get HTML explanation")
