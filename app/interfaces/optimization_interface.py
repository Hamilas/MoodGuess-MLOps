...
class IGPUBatchOptimizer(ABC):
    ...
    @abstractmethod
    def get_optimal_batch_size(self, num_samples: int, input_size: int | None = None) -> int:
        """
    ...
    def distribute_batches(self, texts: list[str]) -> list[tuple[int, list[str]]]:
        ...
        Returns:
            List of (gpu_id, batch_texts) tuples, one per GPU
    ...
    async def process_batch_parallel(
        ...
        Args:
            predict_fn: Synchronous prediction function, called per batch
