...
class ICacheClient(ABC):
    ...
    @abstractmethod
    def get(self, key: str, cache_type: str = CacheType.PREDICTION.value) -> Any | None:
        """
    ...
    def set(
        ...
        key: str,
        value: Any,
        cache_type: str = CacheType.PREDICTION.value,
        ttl: int | None = None,
    ) -> bool:
        """
    ...
    @abstractmethod
    def delete(self, key: str, cache_type: str = CacheType.PREDICTION.value) -> bool:
        """
