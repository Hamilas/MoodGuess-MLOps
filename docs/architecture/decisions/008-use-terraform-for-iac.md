...
MoodGuess requires deployment across multiple environments and cloud providers. Managing infrastructure manually leads to several challenges:
...
terraform {
  ...
  backend "gcs" {
    bucket = "moodguess-terraform-state"
...
resource "google_container_node_pool" "primary_nodes" {
  ...
  node_config {
    ...
    tags = ["moodguess", var.environment]
  }
}
```
...
resource "helm_release" "moodguess" {
