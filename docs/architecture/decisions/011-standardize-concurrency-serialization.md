...
As MoodGuess scales to handle high-throughput workloads (as per [ADR 003](003-use-kafka-for-async-processing.md)), we face challenges related to resource management and data exchange:
