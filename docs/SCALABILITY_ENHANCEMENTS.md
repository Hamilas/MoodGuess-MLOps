...
This document describes the comprehensive scalability enhancements implemented in MoodGuess to support high-throughput, distributed deployments with horizontal scaling capabilities.

## Overview

The scalability enhancements enable MoodGuess to:
...
MLOPS_KAFKA_CONSUMER_GROUP=moodguess_consumer_group
...
MLOPS_REDIS_NAMESPACE=moodguess
...
kubectl get hpa moodguess-hpa --watch

# View logs
kubectl logs -f deployment/moodguess

# Scale manually (if needed)
kubectl scale deployment moodguess --replicas=5
```
