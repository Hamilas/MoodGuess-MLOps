...
This document tracks all changes to the MoodGuess API, including new endpoints, modifications to existing endpoints, deprecations, and breaking changes. Follow [Semantic Versioning](https://semver.org/) principles.
...
- **Initial Production Release** of MoodGuess API
...
- **GitHub Issues**: https://github.com/Hamilas/MoodGuess/issues
