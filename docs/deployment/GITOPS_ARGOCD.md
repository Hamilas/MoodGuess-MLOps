...
This document describes the GitOps-based deployment architecture for MoodGuess using ArgoCD.
...
MoodGuess uses **GitOps** principles for deployments, with ArgoCD as the continuous delivery tool. This approach provides:
...
metadata:
  ...
  namespace: argocd
spec:
  description: MoodGuess MLOps Project
  sourceRepos: ['*']
  destinations:
...
# Test connection
argocd repo get https://github.com/Hamilas/MoodGuess.git
```
...
argocd app list --repo https://github.com/Hamilas/MoodGuess.git
