...
This document outlines the API versioning approach used in MoodGuess and provides guidance for API consumers and contributors.

## Versioning Approach

MoodGuess uses **URL-based versioning** with the `/api/v1` prefix for all production endpoints.
...
Currently, MoodGuess uses REST API with JSON. Future versions may support:
