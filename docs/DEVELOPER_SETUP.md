# ⚠️ DEPRECATED - MoodGuess Developer Setup Guide
...
This guide walks you through setting up MoodGuess for local development. After completing this guide, you'll have a fully functional development environment with all tools, dependencies, and pre-commit hooks installed.
...
```bash
git clone https://github.com/Hamilas/MoodGuess.git
cd MoodGuess
```
