...
Complete guide to MoodGuess's configuration system, including setup, architecture, profiles, and deployment.
...
MoodGuess uses a **profile-based configuration system** with **domain-driven architecture**. This means:
...
MoodGuess includes 4 built-in profiles optimized for different environments:
