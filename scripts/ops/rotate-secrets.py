    ...
    def rotate_secret(
        ...
        try:
            ...
            try:
                ...
                logger.info(
                    "Backing up current version of secret", extra={"secret_key": secret_key}
                )
            except Exception:
            ...
            logger.info(
                "Rotated secret", extra={"secret_key": secret_key, "environment": environment}
            )
            return True
    ...
    def trigger_kubernetes_rollout(self, namespace: str, deployment_name: str) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    "Failed to load Kubernetes config", extra={"error": str(e)}, exc_info=True
                )
                return False
        ...
        try:
            ...
            logger.error(
                "Failed to trigger Kubernetes rollout", extra={"error": str(e)}, exc_info=True
            )
            return False
    ...
    def _wait_for_rollout(self, namespace: str, deployment_name: str, timeout: int = 300) -> bool:
        ...
        while time.time() - start_time < timeout:
            try:
                ...
                logger.error(
                    "Error checking rollout status", extra={"error": str(e)}, exc_info=True
                )
                return False
