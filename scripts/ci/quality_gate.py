...
class QualityGate:
    ...
    def check_complexity(self) -> bool:
        ...
        success, stdout, stderr = self.run_command(["radon", "cc", "app/", "--min", "B", "--json"])
        ...
        try:
            ...
            print(f"📊 Max complexity: {max_complexity} (threshold: {max_threshold})")
            print(f"📊 Avg complexity: {avg_complexity:.2f} (threshold: {avg_threshold})")
